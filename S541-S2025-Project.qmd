...
```{r}
#Preliminary Data and Power Test
...
**9-Step Checklist** Needs revisions/group input:
...
2.	Identify response and sources of variation. 
    ...
    c.	Sources of variation: Pot material, stove used, burner used, burner size, time to preheat burner, amount of water used, amount of salt used, order of boiling (pot temperature).
...
5.	Pilot experiment: Our pilot experiment yielded the following results:
    a.	SD of small pots:
    b.  Sample size needed for small pots:
    c.  SD of large pots:
    d. Sample size needed for large pots:
    e. Therefore, we will use ______ pots for our experiment.
6.	Specify the model: 
...
8.	Calculate number of observations and time/budget. 
    a.	N: Based on the our pilot study, we will need to complete ______ observations.
    b.	Time: All observations must be completed within two hours. Each pot will take approximately 3 minutes.
